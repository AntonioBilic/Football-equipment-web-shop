"""
Django settings for football_web_shop_project project.
...
SECRET_KEY = 'django-insecure-j=^s9q+kfn($#g2ky@91zw0(r(c3d&ll9oxkxojlrd4avme1!m'
...
ROOT_URLCONF = 'football_web_shop_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'football_web_shop_app.context_processors.wishlist_count',
...
WSGI_APPLICATION = 'football_web_shop_project.wsgi.application'
